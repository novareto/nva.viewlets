...
#
#  $ bin/test -s nva.viewlets -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src nva.viewlets.testing.NVA_VIEWLETS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/nva/viewlets/tests/robot/test_example.robot
#
